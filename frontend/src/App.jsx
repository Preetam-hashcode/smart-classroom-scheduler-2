    ...
    <div className="login-container">
      <div className="login-card">
        <div className="logo-container">
          <img src="/Brainware_University.webp" alt="Logo" className="logo-img" />
        </div>
        ...
        <div className="form-container">
          ...
          <form onSubmit={handleSubmit} className="login-form">
            ...
            {/* Faculty/Admin need a password */}
            {(form.designation === 'Faculty' || form.designation === 'Admin') && (
              <div className="form-group">
                <input
                  type="password"
                  name="password"
            ...
            <button
              ...
              disabled={
                !form.designation ||
                !form.id ||
                ((form.designation === 'Faculty' || form.designation === 'Admin') && !form.password)
              }
              style={{
                background:
